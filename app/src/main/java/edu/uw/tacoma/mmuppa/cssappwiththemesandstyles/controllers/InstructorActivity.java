...
import edu.uw.tacoma.mmuppa.cssappwiththemesandstyles.model.Instructor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAddButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(v.getContext(), "edu.uw.tacoma.mmuppa.cssappwiththemesandstyless.model.Instructor added Successfully!", Toast.LENGTH_SHORT)
                        .show();
